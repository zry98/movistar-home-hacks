...
*Just needs a bit of tapping, a (virtual) Bluetooth keyboard, lots of patience and spare time*
...
While this setup has several limitations, one positive bit is that audio and camera work, something you currently lose if you install Linux on the Mitrastar.
