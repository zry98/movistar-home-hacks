...
Crea el fichero `/etc/systemd/system/fix-sound.service` con el siguiente contenido:
...
Luego ejecuta `sudo systemctl daemon-reload && sudo systemctl enable fix-sound.service` para que se ejecute al iniciar.
