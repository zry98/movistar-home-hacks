...
Terminé instalando _Automate_ (`com.llamalab.automate`), que ahora gestiona el salvapantallas/bloqueo de pantalla, y [algunas otras funciones](https://github.com/zry98/movistar-home-hacks/tree/main/RG3205W/rev5-softhacks/automate-examples) que puedes importar a tu instancia (ver más detalles abajo sobre cada script).
